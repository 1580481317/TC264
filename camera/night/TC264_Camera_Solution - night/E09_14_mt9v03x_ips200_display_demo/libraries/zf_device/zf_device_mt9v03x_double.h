...
#define MT9V03X_1_W               (128)                                             // 总钻风摄像头1 图像宽度     范围 [1-752]
#define MT9V03X_1_H               (81)                                             // 总钻风摄像头1 图像高度     范围 [1-480]
...
#define MT9V03X_1_EXP_TIME_DEF    ( 700 )                                           // 总钻风摄像头1 曝光时间       摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
#define MT9V03X_1_FPS_DEF         ( 140 )                                            // 总钻风摄像头1 图像帧率       摄像头收到后会自动计算出最大FPS，如果过大则设置为计算出来的最大FPS
...
#define MT9V03X_1_GAIN_DEF        ( 36  )                                           // 总钻风摄像头1 图像增益       范围 [16-64]  增益可以在曝光时间固定的情况下改变图像亮暗程度
