...
IFX_INTERRUPT(cc60_pit_ch0_isr, 0, CCU6_0_CH0_ISR_PRIORITY)
{
    ...
    Yaw=last_yaw+imu660rb_gyro_transition(imu660rb_gyro_z)*0.01;
    last_yaw=Yaw;
}
...
IFX_INTERRUPT(cc60_pit_ch1_isr, 0, CCU6_0_CH1_ISR_PRIORITY)
{
    ...
    Encoder_Data_Get();
    control_core(mid_err,zero);
//    printf("%f,%d,%f\r\n",right_speed,motor_encoder_right.encoder_speed,right_speed_target);
//    printf("%f,%d,%f\r\n",left_speed,motor_encoder_left.encoder_speed,left_speed_target);
